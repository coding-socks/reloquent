...
namespace CodingSocks\Reloquent\Eloquent;
...
abstract class Model implements Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
    use Concerns\HasAttributes,
        EloquentConcerns\HasEvents,
        EloquentConcerns\HasGlobalScopes,
        EloquentConcerns\HasRelationships,
        EloquentConcerns\HasTimestamps,
        EloquentConcerns\HidesAttributes,
        EloquentConcerns\GuardsAttributes,
        ForwardsCalls;
     ...
     *
     * @param  string|null  $connection
     * @return \CodingSocks\Reloquent\Eloquent\Builder
     */
     ...
     *
     * @param  \CodingSocks\Reloquent\Eloquent\Builder  $query
     * @return bool
     */
    ...
    {
        $query->whereKey($this->getKeyForSaveQuery());
     ...
     *
     * @return \CodingSocks\Reloquent\Eloquent\Builder|static
     */
     ...
     *
     * @param  \CodingSocks\Reloquent\Eloquent\Builder  $builder
     * @return \CodingSocks\Reloquent\Eloquent\Builder
     */
    ...
    {
        return (new Builder($query))->schema($this->getSchema());
    }
     ...
     *
     * @param  \CodingSocks\Reloquent\Eloquent\Model  $parent
     * @param  array  $attributes
     * @param  string  $table
     * @param  bool  $exists
     ...
     *
     * @param  \CodingSocks\Reloquent\Eloquent\Model|null  $model
     * @return bool
     */
     ...
     *
     * @return \CodingSocks\Reloquent\Connection
     */
     ...
     * @return \CodingSocks\Reloquent\Eloquent\Model|null
     */
     ...
     * Retrieve the model for a bound value.
     *
     * @param  \CodingSocks\Reloquent\Eloquent\Model|\Illuminate\Database\Eloquent\Relations\Relation  $query
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \Illuminate\Database\Eloquent\Relations\Relation
     */
