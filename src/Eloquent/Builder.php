 ...
 *
 * @mixin \CodingSocks\Reloquent\Query\Builder
 */
class Builder
{
     ...
     *
     * @var \CodingSocks\Reloquent\Eloquent\Model
     */
    protected $model;
    ...
    public function whereKey($id)
    {
        ...
        if (is_array($id) || $id instanceof Arrayable) {
            throw new \LogicException("This database engine does not support selection by multiple ids.");
        }
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \CodingSocks\Reloquent\Eloquent\Model|\Illuminate\Database\Eloquent\Collection
     */
    ...
    public function findMany($ids, $columns = [])
    {
        ...
        // TODO: functionality to run multiple get commands and aggregate the results.
        foreach ($ids as $id) {
            $collection[] = $this->query->find($id, $columns);
        }

        return $this->model->hydrate($collection);
    }
